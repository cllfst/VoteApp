...
<div class="polls index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <th scope="col"><?= $this->Paginator->sort('is_open') ?></th>
        ...
        <?php foreach ($polls as $poll): ?>
            <tr>
                ...
                <td><?= h($poll->is_open) ?></td>
                <td class="actions">
                    <?php if($poll->is_open): ?>
                    <?= $this->Html->link(__('Vote'), ['action' => 'view', $poll->id]) ?>
                    <?php else: ?>
                    <?= $this->Html->link(__('Results'), ['action' => 'view', $poll->id]) ?>
                    <?php endif; ?>
